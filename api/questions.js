// Question bank for NZ ETCO Electrical Theory Exam
// Types: mcq (multiple choice), fill (fill in blank), calc (calculation), multi (multi-select)
...
const questions = [
  ...
  },
  {
    ...
    answer: '26.6m',
    workings: 'From Table C7, VD factor for 6mm² = 306 mV/A·m at 1%\nMax length = (VD factor × allowed %) / current\n= (306 × 2.0) / 23 = 612 / 23 = 26.6m',
  ...
  },
  {
    ...
    answer: '16mm²',
    workings: 'Step 1: Current = 80,000 / (1.732 × 400) = 115.47A\nStep 2: %VD per A·m = (115.47 × 35) / 2.5 = 4041.45 / 2.5 = 1616.6\nFrom Table C7, next size up ≥ 1617 → 16mm² (factor ≈ 1640)',
    hint: 'I = P / (√3 × V), then find cable factor = (I × L) / %VD, match to Table C7'
  },
  {
    id: 9,
    type: 'mcq',
  ...
  },
  {
    ...
    options: [
      'Over 1000V ac or 1500V dc',
      'Over 1000V ac to 11kV ac',
      'Greater than 55V ac and 120V dc',
      'Greater than 11kV'
    ],
    answer: 0
  },
  ...
  },
  {
    ...
    options: [
      ...
      'Single Extra Low Voltage',
      'Specified Extra Low Voltage'
    ],
    answer: 0
  },
  {
  ...
  },
  {
    ...
    options: [
      '0.75m with doors in any position',
      '0.6m with doors in any position',
      '0.6m with doors closed',
      '0.75m with doors open'
    ],
    answer: 1
  },
  {
  ...
  },
  {
    ...
    answer: '73.2A',
    workings: 'Group A(i) indoor lighting: (30×50 + 25×8 + 4×75) = 1800W → 1800/230 = 7.83A × 0.9 demand = 7A\nGroup A(ii) outdoor lighting: 10×150 = 1500W → 1500/230 = 6.52A × 0.75 = 4.89A\nGroup B sockets: 16×2 + 10×1 = 42 outlets → first 10 = 10A, next 32 × 0.4A = 12.8A → 22.8A rounded to 20A\nGroup C range: 4000/230 = 17.39A × 0.5 = 8.7A\nGroup D sauna: 6000/230 = 26.09A × 0.75 = 19.57A\nGroup F water heater: 3000/230 = 13.04A\nTotal = 7 + 4.89 + 20 + 8.7 + 19.57 + 13.04 = 73.2A',
    hint: 'Apply Appendix C demand factors to each group: A(i) lighting, A(ii) outdoor, B sockets, C cooking, D other fixed, F water heating'
  },
  {
    id: 30,
    type: 'mcq',
